...
following packages will be built::
        ...
        build/dist/scons-2.3.1.tar.gz
        build/dist/scons-2.3.1.win32.exe
        build/dist/scons-2.3.1.zip
        build/dist/scons-doc-2.3.1.tar.gz
        build/dist/scons-local-2.3.1.tar.gz
        build/dist/scons-local-2.3.1.zip
        build/dist/scons-src-2.3.1.tar.gz
        build/dist/scons-src-2.3.1.zip
